! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        var o = this,
            i = e("<form></form>");
        i.append("<label>Змінити назву події</label>"), i.append("<div class='input-group'><input class='form-control' type=text value='" + t.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa fa-check'></i> Зберегти</button></span></div>"), o.$modal.modal({
            backdrop: "static"
